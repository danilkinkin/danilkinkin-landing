// Temp solution for support Node.js Connect style API to Request/Response
// Issue: https://github.com/vitejs/vite/issues/15389
// Solution from: https://github.com/vikejs/vike-node/blob/main/packages/vike-node/src/runtime/adapters/connectToWeb.ts
...
import type { ConnectMiddleware, WebHandler } from "./types.ts";
